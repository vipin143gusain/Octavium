...
// ================= Company List (Row Selected) =================
export function CompanyListSelectedPage() {
   return (
      <div className='min-h-screen bg-gray-100 p-6'>
         <div className='mb-4 text-gray-400'>
            Company List when user click any organization
         </div>
            ...
            <div className='p-4'>
               ...
               <div className='flex mb-2 border-b'>
                  {[
                     ...
                     <button
                        key={t}
                        className={`px-6 py-2 text-sm border-r ${
                           i === 0 ? 'bg-blue-500 text-white' : 'bg-blue-100'
                        }`}>
                        {t}
                     </button>
                  ))}
